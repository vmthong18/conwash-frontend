...
export default async function Page() {
  ...
  const ordersRes = await fetch(
    `${base}/items/donhang?fields=ID,GhiChu,GoiHangs,ID_KhachHang.ID,ID_KhachHang.TenKhachHang,ID_KhachHang.DienThoai,ID_DiaDiem&filter[TrangThai][_eq]=GHEP_DON&limit=-1&filter[NguoiNhap][_eq]=${me.id}`,
